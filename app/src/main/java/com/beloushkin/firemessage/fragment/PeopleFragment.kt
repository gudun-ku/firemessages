...
import com.beloushkin.firemessage.AppConstants
import com.beloushkin.firemessage.ChatActivity
    ...
    private val onItemClick = OnItemClickListener { item, view ->
        if (item is PersonItem) {
            startActivity<ChatActivity>(
                AppConstants.USER_NAME to item.person.name,AppConstants.USER_ID to item.userId
            )
        }
    }
